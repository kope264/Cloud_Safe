...
const Dashboard = () => {
  ...
  const [folders, setFolders] = useState([]); // Corrected typo
  ...
  const handleCreateFolder = () => {
    ...
    const CreateCollectionbyFolderName=async()=>{
                ...
                {folders
                  ...
                  .map((folder) => (
                    <div className="folder-item" key={folder.id}>
                      <div className="folder-icon" onClick={() => openFolder(folder)}>
                        📁
                      </div>
        ...
        <div className="modal-overlay">
          <div className="modal">
            ...
            <div className="modal-actions">
              ...
              <button className="modal-btn upload" onClick={handleFileUpload} disabled={!fileToUpload}>
                Upload
              </button>
            </div>
          </div>
        ...
        <div className="modal-overlay">
          <div className="modal">
            ...
            <div className="modal-actions">
              ...
              <button className="modal-btn share" onClick={handleShareFile} disabled={!shareEmail.trim()}>
                Share
              </button>
            </div>
          </div>
